-- ════════════════════════════════════════════════════════════════════════
--  CustomUI  –  Roblox UI Library  v4.0  (real TDS assets)
...
-- ─── Real TDS Asset IDs (scraped directly from the game) ─────────────────
-- rbxassetid:// works natively in ImageLabel.Image — no download needed.
local A = {
    -- UI glyphs (21×21)
    Check      = "rbxassetid://99824465061925",   -- toggle ON  checkmark
    X          = "rbxassetid://139144590557777",  -- toggle OFF / close X
    Chevron    = "rbxassetid://72267574514090",   -- dropdown chevron
    Search     = "rbxassetid://89701503974482",   -- search magnifier

    -- Wave decoration (200×21, used below section headers)
    Wave       = "rbxassetid://11331510551",

    -- Tab / section icons (21×21, sidebar order: All→Keybinds)
    IconGear   = "rbxassetid://17771284125",      -- All / Gameplay
    IconAudio  = "rbxassetid://86488391009945",   -- Audio
    IconEye    = "rbxassetid://17827903674",      -- Graphics
    IconTarget = "rbxassetid://17769663408",      -- Units
    IconSkull  = "rbxassetid://121998499432128",  -- Enemies
    IconDots   = "rbxassetid://111040652004968",  -- Miscellaneous
    IconKeys   = "rbxassetid://86752529370062",   -- Keybinds
    IconFlask  = "rbxassetid://134556475229858",  -- Testing / section icon (42×47)

    -- Sidebar decorations
    IconPerson    = "rbxassetid://117379986310860",  -- 135×135 wheel logo (buttons)
    SidebarBanner = "rbxassetid://96636463928154",   -- 378×98  "Settings" title banner
    SidebarBg     = "rbxassetid://107375820802756",  -- 1130×672 sidebar background
    HeaderDeco    = "rbxassetid://138476777747027",  -- 218×545 scrollwork decoration

    -- Custom tab background (user's own PNG — downloaded once to workspace)
    TabBg = "",  -- filled below after download
}

-- Download the user's custom tab_bg.png once if needed
local TAB_BG_PATH = "CustomUI/tab_bg.png"
local TAB_BG_URL  = "https://raw.githubusercontent.com/PXG4E/TestUI/main/assets/ui/tab_bg.png"
if not isfolder("CustomUI") then makefolder("CustomUI") end
if not isfile(TAB_BG_PATH) then
    local ok, res = pcall(function() return game:HttpGet(TAB_BG_URL, true) end)
    if ok and res and #res > 0 then writefile(TAB_BG_PATH, res) end
end
A.TabBg = getcustomasset(TAB_BG_PATH)
